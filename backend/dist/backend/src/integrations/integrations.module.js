...
exports.IntegrationsModule = IntegrationsModule = __decorate([
    (0, common_1.Module)({
        imports: [config_1.ConfigModule, config_2.AppConfigModule],
        providers: [ai_client_service_1.AiClientService, weather_client_service_1.WeatherClientService],
        controllers: [integrations_controller_1.IntegrationsController],
        exports: [ai_client_service_1.AiClientService, weather_client_service_1.WeatherClientService],
    })
], IntegrationsModule);
